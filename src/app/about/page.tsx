...
export const metadata = {
  title: 'About EveryCentCalc — 100 Free Financial Calculators',
  description: 'Built by a freelancer who was tired of guessing how much to save for taxes. 100 free calculators with 2026 IRS rates. No signup required.',
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 md:py-20">
        ...
        <div className="space-y-6 text-base leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <p>
            That&apos;s why I built EveryCentCalc — a collection of <strong style={{ color: 'var(--text-primary)' }}>100 free financial calculators</strong> designed specifically for people like us: freelancers, side hustlers, gig workers, and small business owners who need real numbers, not generic advice.
          </p>
          ...
          <p>
            Running 100 calculators with current tax data isn&apos;t free for us either. Here&apos;s how we keep the lights on without charging you a cent:
          </p>
